...
async def test_coordinator(hass):
    async with async_get_clientsession(hass) as session:
        with aioresponses() as m:
            ...
            m.post("https://securetoken.googleapis.com/v1/token?key=AlzaSyBK2HLTRsVtTBcF3uGg-ICYTkpJObsTig",
                   payload={"id_token": "test_access_token", "refresh_token": "test_refresh_token",
                            "expires_in": "3600"})
